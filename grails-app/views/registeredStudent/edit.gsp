...
<html>
	...
	<body>
		<a href="#edit-registeredStudent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-registeredStudent" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${registeredStudentInstance?.version}" />
				<fieldset class="form">
